    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-6">
      <div className="w-full max-w-[420px] flex flex-col items-center gap-7">
        <div className="flex flex-col items-center gap-2">
          ...
          <span className="t-heading">PeopleCore Admin</span>
          <span className="eyebrow">224tech internal</span>
        </div>
        ...
        <p className="t-small text-center">Access restricted to office network / VPN</p>
      </div>
    </div>
  );
}
